...
// Print squares smaller than 400 of all odd numbers in between 1 and 30
assert [1, 9, 25, 49, 81, 121, 169, 225, 289, 361] == (1..30).findAll {it%2 != 0}.collect {it*it}.findAll {it<400}
