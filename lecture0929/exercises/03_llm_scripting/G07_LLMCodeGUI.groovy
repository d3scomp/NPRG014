...
def connector = new LLMChatConnector(debug: false, systemPrompt: 'You are a coding assistant. All your responses must be valid idiomatic Groovy code, unless asked otherwise.')
                                            ...
                                            button(
                                                    ...
                                                    actionPerformed: {
                                                        ...
                                                        try {
                                                            ...
                                                            binding.setVariable('currentFrame', mainFrame)
                                                            def shell = new GroovyShell(binding)
                                                            shell.evaluate(codeToRun)
